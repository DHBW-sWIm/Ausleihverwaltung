...
class restore_ausleihverwaltung_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('ausleihverwaltungVIEWBYID', '/mod/ausleihverwaltung/new_resource_view.php?id=$1', 'course_module');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('ausleihverwaltung', 'add', 'new_resource_view.php?id={course_module}', '{ausleihverwaltung}');
        $rules[] = new restore_log_rule('ausleihverwaltung', 'update', 'new_resource_view.php?id={course_module}', '{ausleihverwaltung}');
        $rules[] = new restore_log_rule('ausleihverwaltung', 'view', 'new_resource_view.php?id={course_module}', '{ausleihverwaltung}');
