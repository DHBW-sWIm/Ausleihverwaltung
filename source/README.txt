...
* Rename the testmodule/ folder to the name of your module (eg "widget").
...
* Rename the file lang/en/testmodule.php to lang/en/widget.php
  where "widget" is the name of your module

* Rename all files in backup/moodle2/ folder by replacing "testmodule" with
  the name of your module

  On Linux you can perform this and previous steps by calling:
  $ find . -depth -name '*testmodule*' -execdir bash -c 'mv -i "$1" "${1//testmodule/widget}"' bash {} \;
...
* Go to Site Administration > Plugins > Activity modules > Manage activities
  and you should find that this testmodule has been added to the list of
  installed modules.
