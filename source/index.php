...
$event = \mod_apeinsdrei\event\course_module_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

$strname = get_string('modulenameplural', 'mod_apeinsdrei');
$PAGE->set_url('/mod/apeinsdrei/index.php', array('id' => $id));
...
$currentsection = '';
foreach ($modinfo->instances['apeinsdrei'] as $cm) {
    $row = array();
    if ($usesections) {
