...
/**
 * Internal library of functions for module genehmigungsansicht
 *
 * All the genehmigungsansicht specific functions, needed to implement the module
...
function genehmigungsansicht_do_something_useful(array $things) {
    return new stdClass();
}

function genehmigungsansicht_get_process_definition_id($processKey) {
	global $processDefinitionsApiInstance;
...
function genehmigungsansicht_start_process($process_definition_id, $business_key) {
	global $processInstancesApiInstance;
...
function genehmigungsansicht_check_for_input_required($process_instance_id) {
	global $tasksApiInstance;
	try {
...
function genehmigungsansicht_answer_input_required($task_id, $process_definition_id, $value1, $value2) {
	global $formsApiInstance;
...
function genehmigungsansicht_get_process_instance_status($process_instance_id) {
	global $processInstancesApiInstance;
