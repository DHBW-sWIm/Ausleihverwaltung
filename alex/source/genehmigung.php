...
$PAGE->set_url('/mod/genehmigungsansicht/genehmigung.php', array('id' => $cm->id));
...
echo $OUTPUT->heading('Genehmigungsansicht: Details');
...
echo $OUTPUT->single_button(new moodle_url('../genehmigungsansicht/view.php', array('antragid' => $antragID)), 'Abbrechen');
echo $OUTPUT->single_button(new moodle_url('../genehmigungsansicht/genehmigung_genehmigen.php', array('id' => $cm->id, 'antragid' => $antragID, 'rowid' => $rowID)), 'Genehmigen', $attributes=null);
echo $OUTPUT->single_button(new moodle_url('../genehmigungsansicht/genehmigung_frage.php', array('id' => $cm->id, 'antragid' => $antragID, 'rowid' => $rowID)), 'Frage stellen', $attributes=null);
echo $OUTPUT->single_button(new moodle_url('../genehmigungsansicht/genehmigung_ablehnen.php', array('id' => $cm->id, 'antragid' => $antragID, 'rowid' => $rowID)), 'Ablehnen', $attributes=null);
